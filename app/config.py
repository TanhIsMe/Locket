...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8713191831:AAF_6jOcpgW-vTzoiQyl0AwEppl9mx0P8zY")
NEXTDNS_KEY = os.environ.get("NEXTDNS_KEY", "fd51de515206a9da823f5588f4bfb16340a0e4c0")

TOKEN_SETS = [
    {
        "fetch_token": "sk_RqeVayUZBKmGayIcRWmVeUtKvnqoP",
        "app_transaction": "",
        "hash_params": "",
        "hash_headers": "",
        "is_sandbox": True,
